...
function CareerGuidance() {
  ...
  useEffect(() => {
    ...
    fetch(`http://localhost:5000/api/guidance/roadmap/${studentId}`)
      .then(res => res.json())
      .then(data => {
    ...
    fetch(`http://localhost:5000/api/guidance/job-roles/${studentId}`)
      .then(res => res.json())
      .then(data => {
    ...
    fetch(`http://localhost:5000/api/guidance/company-eligibility/${studentId}`)
      .then(res => res.json())
      .then(data => {
