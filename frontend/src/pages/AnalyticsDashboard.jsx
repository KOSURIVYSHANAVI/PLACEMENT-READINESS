...
function AnalyticsDashboard() {
  ...
  useEffect(() => {
    ...
    fetch(`http://localhost:5000/api/analytics/dashboard/${studentId}`)
      .then(res => res.json())
      .then(data => setDashboardData(data));

    fetch(`http://localhost:5000/api/analytics/chart/${studentId}`)
      .then(res => res.json())
      .then(data => setChartData(data));

    fetch(`http://localhost:5000/api/analytics/timeline/${studentId}`)
      .then(res => res.json())
      .then(data => setTimeline(data.timeline || []));

    fetch(`http://localhost:5000/api/analytics/comparison/${studentId}`)
      .then(res => res.json())
